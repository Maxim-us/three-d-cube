...
class MXTDC_Model
{
	...
	* Table name
	*/
	protected $table = MXTDC_TABLE_SLUG;
	...
	*/
	public function mxtdc_get_row( $table = NULL, $wher_name, $wher_value )
	{
	...
	*/
	public function mxtdc_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
